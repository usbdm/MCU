...
HALL_Handle_t HALL_M1 =
{
 ...
 .H1Port             =  HALL_A_GPIO_Port,
 .H1Pin              =  HALL_A_Pin,
 .H2Port             =  HALL_B_GPIO_Port,
 .H2Pin              =  HALL_B_Pin,
 .H3Port             =  HALL_C_GPIO_Port,
 .H3Pin              =  HALL_C_Pin,
...
Throttle_Handle_t *pThrottleSensor[NBR_OF_MOTORS] = {&ThrottleSensor_M1};
CTS_Handle_t *pControlTemperatureSensor[NBR_OF_MOTORS] = {&ControlTempSensor_M1};
