...
#define  MC_OVERCURRENT_FAULT       ((uint16_t)0x0010) /**< @brief Error: Startup failed.*/
...
#define  MC_CALIBRATION_FAULT       ((uint32_t)0x00000100) /**< @brief Error:  .*/
#define  MC_MOTORSTUCK_FAULT        ((uint32_t)0x00000200) /**< @brief Error:  .*/
#define  MC_THROTTLE_FAULT_HIGH     ((uint32_t)0x00000400) /**< @brief Error:  .*/
#define  MC_THROTTLE_FAULT_LOW      ((uint32_t)0x00000800) /**< @brief Error:  .*/
#define  MC_HALLSTATE_FAULT         ((uint32_t)0x00001000) /**< @brief Error:  .*/
#define  MC_OVERSPEED_FAULT         ((uint32_t)0x00002000) /**< @brief Error:  .*/
#define  MC_CTRL_OVERTEMP_FAULT     ((uint32_t)0x00004000) /**< @brief Error:  .*/
...
/**
  * @brief  Specifies the vehicle modes of the motor
  */
