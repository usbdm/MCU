...
extern Throttle_Handle_t ThrottleSensor_M1;
extern CTS_Handle_t ControlTempSensor_M1;
extern RegConv_t ThrottleRegConv_M1;
extern RegConv_t CtsTempRegConv_M1;
extern PWMC_Handle_t *pwmcHandle[NBR_OF_MOTORS];

extern NTC_Handle_t *pTemperatureSensor[NBR_OF_MOTORS];
extern Throttle_Handle_t *pThrottleSensor[NBR_OF_MOTORS];
