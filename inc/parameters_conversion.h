...
#define CURRENT_CONV_FACTOR		(uint16_t)((65536.0 * RSHUNT * AMPLIFICATION_GAIN)/ADC_REFERENCE_VOLTAGE) // 280
...
#define THROTTLE_UNDERVOLTAGE_d    (uint16_t)((THROTTLE_UNDERVOLTAGE_V*65536)/(ADC_REFERENCE_VOLTAGE))
#define THROTTLE_OVERERVOLTAGE_d   (uint16_t)((THROTTLE_OVERVOLTAGE_V*65536)/(ADC_REFERENCE_VOLTAGE))

#define INT_SUPPLY_VOLTAGE          (uint16_t)(65536/ADC_REFERENCE_VOLTAGE)

#define DELTA_TEMP_THRESHOLD        (OV_TEMPERATURE_THRESHOLD_C- MTR_T0_C)
#define DELTA_V_THRESHOLD           (MTR_dV_dT * DELTA_TEMP_THRESHOLD)
#define OV_TEMPERATURE_THRESHOLD_d  ((MTR_V0_V + DELTA_V_THRESHOLD)*INT_SUPPLY_VOLTAGE)

#define DELTA_CTRLTEMP_THRESHOLD     (OV_CTRLTEMP_THRESHOLD_C- T0_C)
#define DELTA_V_CTRLTHRESHOLD        (dV_dT * DELTA_CTRLTEMP_THRESHOLD)
#define OV_CTRLTEMP_THRESHOLD_d      ((V0_V + DELTA_V_CTRLTHRESHOLD)*INT_SUPPLY_VOLTAGE)

#define DELTA_TEMP_HYSTERESIS        (OV_TEMPERATURE_HYSTERESIS_C)
#define DELTA_V_HYSTERESIS           (MTR_dV_dT * DELTA_TEMP_HYSTERESIS)
#define OV_TEMPERATURE_HYSTERESIS_d  (DELTA_V_HYSTERESIS*INT_SUPPLY_VOLTAGE)

#define DELTA_CTRLTEMP_HYSTERESIS    (OV_CTRLTEMP_HYSTERESIS_C)
#define DELTA_V_CTRLHYSTERESIS       (dV_dT * DELTA_CTRLTEMP_HYSTERESIS)
#define OV_CTRLTEMP_HYSTERESIS_d     (DELTA_V_CTRLHYSTERESIS*INT_SUPPLY_VOLTAGE)
