...
/**
  ...
  * stopped, the application can query Motor 1's state machine and check if the
...
uint8_t MC_GetDriveinput(MCI_Handle_t *pHandle)
{
	return  (pHandle->pFOCVars->bDriveInput);
}
